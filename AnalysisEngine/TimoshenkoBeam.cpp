...
TimoshenkoBeam::TimoshenkoBeam(unsigned int ElmIndex, Node* iNode, Node* jNode, Section* section, Material* material, Hinge* iEndHinge, Hinge* jEndHinge)
{
...
void TimoshenkoBeam::AssembleElementLocalStiffnessMatrix()
{
	...
	kElm[1][1] = 12 * E * I11 * shearMultiplier / L3;
	kElm[1][5] = 6 * E * I11 / L2;
	kElm[1][7] = -12 * E * I11 * shearMultiplier / L3;
	...
	kElm[7][1] = kElm[1][7];
	kElm[7][5] = kElm[5][7];
	kElm[7][7] = 12 * E * I11 * shearMultiplier / L3;
...
/// </summary>
void TimoshenkoBeam::AssembleElementLocalMassMatrix()
{
	auto A = this->FrameSection->Area;
...
void TimoshenkoBeam::AssembleElementRotationMatrix()
{
...
void TimoshenkoBeam::AssembleElementGlobalStiffnessMatrix()
{
...
void TimoshenkoBeam::AssembleElementGlobalMassMatrix()
{
